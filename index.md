...
|---|---|---|
| [yakiben](https://github.com/Ashok314/yakiben) | Japanese lunch-box pre-order system — customer & admin apps, PWA | Vue 3, TypeScript, Supabase |
| [election-np](https://github.com/Ashok314/election-np) | Real-time Nepal election dashboard with interactive choropleth map | React, Vite, Supabase, Puppeteer |
| [nlp](https://github.com/Ashok314/nlp) | Japanese profanity filter & sentiment analysis | Python, MeCab, FastText |
| [Rnotebook](https://github.com/Ashok314/Rnotebook) | Software defect analysis & prediction on NASA KC1 dataset | R |
...
Thesis: [*Program Testing Using Separation Logic Formula*](https://www.waseda.jp/fsci/assets/uploads/2021/04/8c576477c2a327565a235bef80c6dfde.pdf) *(2020年度 基幹理工学研究科 修士論文 — 情報理工・情報通信専攻)*  
Research Lab (M.S.): [Terauchi Laboratory](https://terauchi.w.waseda.jp/) — [Past Students](https://terauchi.w.waseda.jp/paststudents.html)
...
- [GitHub](https://github.com/Ashok314)
- [LinkedIn](https://www.linkedin.com/in/ashok314/)
- [Blog](https://pi.hashnode.dev)
- [Old Google Site](https://sites.google.com/view/ashok314)
