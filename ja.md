...
研究分野は**ソフトウェア検証・テスト**で、特に**分離ロジック（Separation Logic）**を用いたプログラムの正確さの保証に取り組んできました。動的メモリを使用するCプログラムに対して、分離ロジック式とSATソルバーを用いたテストケース生成システムを開発しました。
...
- [ブログ](https://pi.hashnode.dev)
- [旧Googleサイト](https://sites.google.com/view/ashok314)
